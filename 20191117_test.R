...
write.table(nIESct2contentsVF, "nIESct2contentsVF.csv", sep="$", append=FALSE, row.names = F, quote = FALSE, na = "NA")
...
write.table(nIESct2ctmetasVF, "nIESct2ctmetasVF.csv", sep="$", append=FALSE, row.names = F, quote = FALSE, na = "NA")
